...
public class HelpRequestWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_helpRequest() throws Exception {
        ...
        page.getByTestId("HelpRequestForm-requesterEmail").fill("awin@ucsb.edu");
        page.getByTestId("HelpRequestForm-teamId").fill("s25-05");
        page.getByTestId("HelpRequestForm-tableOrBreakoutRoom").fill("table");

        page.getByTestId("HelpRequestForm-requestTime").fill("2022-01-03T12:00");
             
        page.getByTestId("HelpRequestForm-explanation").fill("Need help with the project");
        ...
        page.getByTestId("HelpRequestForm-teamId").fill("s25-06");
        page.getByTestId("HelpRequestForm-submit").click();

        assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-teamId")).hasText("s25-06");
